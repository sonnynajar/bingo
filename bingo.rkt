...
(define events-list
  (list
   ...
   "We get a summer camp set up in another city"
   "We get a weekly class set up in another city"
   "We hire someone in another city"
   "We get a student enrollment from another city"
...
(define (make-grid #:v [p "0"])
  ...
  (pict->bitmap
   (vc-append
    ...
    (text "Board is valid from 12/03/2019 to 12/31/2019")
    (blank 5)
    (hc-append 
     (vc-append
    ...
    (vc-append
     ...
     (blank 10)
     (text "Winning Pattern: Two X Signs - unique or sharing NO MORE than 1 square")
     (blank 5)
     (hc-append
      (text "Allowed (unique): ") (two-exes-touching-1) (text " or ") (two-exes-touching-2) (text " or ") (two-exes-touching-3)(text " or ") (two-exes-touching-4))
     (hc-append
      (text "Allowed (sharing 1 square): " ) (two-exes-sharing-1) (text " or ") (two-exes-sharing-2) (text " Not Allowed: ") (two-exes-superimposed))
     (blank 10)
     (text (~a "Card #" p))))))
